...
class Message {
    ...
    constructor(id: string, userId: string, avatar: string, username: string, guestname: string, content: string, timestamp: number, systemName: string, tag: string, tagColour: string) {
        this._id = id;
        this._userId = userId;
        this._avatar = avatar;
