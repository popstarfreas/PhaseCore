class Item {
  public static ids: Array<string> = [
      ...
      "Blue Dragonfly Jar",
      "Green Dragonfly Jar",
      "Orange Dragonfly Jar",
      "Red Dragonfly Jar",
      "Yellow Dragonfly Jar",
      "Gold Dragonfly Jar",
      "Black Dragonfly",
      "Blue Dragonfly",
      "Green Dragonfly",
      ...
      "Corrupt Growth Wall",
      "Corrupt Mass Wall",
      "Corrupt Pustule Wall",
      "Corrupt Tendril Wall",
      "Crimson Crust Wall",
      "Crimson Scab Wall",
      "Crimson Teeth Wall",
      "Crimson Blister Wall",
      "Layered Dirt Wall",
      "Crumbling Dirt Wall",
      "Cracked Dirt Wall",
      "Wavy Dirt Wall",
      "Hallowed Prism Wall",
      "Hallowed Cavern Wall",
      "Hallowed Shard Wall",
      "Hallowed Crystalline Wall",
      "Lichen Stone Wall",
      "Leafy Jungle Wall",
      "Ivy Stone Wall",
      "Jungle Vine Wall",
      ...
      "Cinder Wall",
      "Magma Wall",
      "Smouldering Stone Wall",
      "Worn Stone Wall",
      "Stalactite Stone Wall",
      "Mottled Stone Wall",
      ...
      "Bamboo Table",
      "Bamboo Work Bench",
      "Trapped Bamboo Chest",
      "Bamboo Toilet",
      "Worn Golf Club (Iron)",
      "Worn Golf Club (Putter)",
      "Worn Golf Club (Wedge)",
      "Worn Golf Club (Driver)",
      "Fancy Golf Club (Iron)",
      "Fancy Golf Club (Putter)",
      "Fancy Golf Club (Wedge)",
      "Fancy Golf Club (Driver)",
      "Premium Golf Club (Iron)",
      "Premium Golf Club (Putter)",
      "Premium Golf Club (Wedge)",
      "Premium Golf Club (Driver)",
      "Bronze Golf Trophy",
      "Silver Golf Trophy",
      "Gold Golf Trophy",
      ...
      "Blue Fairy Jar",
      "The Rolling Greens",
      "Study of a Ball at Rest",
      "Fore!",
      "The Duplicity of Reflections",
      "Fogbound Dye",
      "Bloodbath Dye",
      "Pretty Pink Dress",
      ...
      "Hallowed Campfire",
      "Jungle Campfire",
      "Soul of Light in a Bottle",
      "Soul of Night in a Bottle",
      "Soul of Flight in a Bottle",
      "Soul of Sight in a Bottle",
      "Soul of Might in a Bottle",
      "Soul of Fright in a Bottle",
      "Mud Bud",
      "Release Lantern",
      "Quad-Barrel Shotgun",
      "Funeral Hat",
      ...
      "Ornate Shadow Key",
      "Dr. Man Fly Mask",
      "Dr. Man Fly's Lab Coat",
      "Butcher Mask",
      "Butcher's Bloodstained Apron",
      "Butcher's Bloodstained Pants",
      "Football",
      "Hunter Cloak",
      "Coffin Minecart",
      ...
      "Safeman's Sunny Day",
      "Safeman's Sun Dress",
      "Safeman's Pink Leggings",
      "FoodBarbarian's Tattered Dragon Wings",
      "FoodBarbarian's Horned Helm",
      "FoodBarbarian's Wild Wolf Spaulders",
      "FoodBarbarian's Savage Greaves",
      ...
      "Hanging Shiverthorn",
      "Hanging Blinkroot",
      "Hanging Corrupt Deathweed",
      "Hanging Crimson Deathweed",
      "Hanging Fireblossom",
      "Hanging Brazier",
      "Mini Volcano",
      "Large Volcano",
      ...
      "Diamond Bunny Cage",
      "Amber Bunny Cage",
      "Amethyst Squirrel Cage",
      "Topaz Squirrel Cage",
      "Sapphire Squirrel Cage",
      "Emerald Squirrel Cage",
      "Ruby Squirrel Cage",
      "Diamond Squirrel Cage",
      "Amber Squirrel Cage",
      "Ancient Hallowed Mask",
      "Ancient Hallowed Helmet",
      "Ancient Hallowed Headgear",
      "Ancient Hallowed Hood",
      "Ancient Hallowed Plate Mail",
      "Ancient Hallowed Greaves",
      "Potted Magma Palm",
      "Potted Brimstone Bush",
      "Potted Fire Brambles",
      "Potted Lava Bulb",
      "Potted Ember Tendrils",
      ...
      "Rock Golem Banner",
      "Blood Mummy Banner",
      "Spore Skeleton Banner",
      "Spore Bat Banner",
      "Antlion Larva Banner",
      "Vicious Bunny Banner",
      "Vicious Goldfish Banner",
      "Vicious Penguin Banner",
      "Corrupt Mimic Banner",
      "Crimson Mimic Banner",
      "Hallowed Mimic Banner",
      "Moss Hornet Banner",
      "Wandering Eye Banner",
      "Fledgling Wings",
