class Item {
    static IDs: Array<String> = [
      ...
      'Martian Hair Dye',
      'Martian Dye',
      'Painting Castle Marsberg',
      'Painting Martia Lisa',
      'Painting The Truth Is Up There',
      'Smoke Block',
      'Living Flame Dye',
      'Living Rainbow Dye',
      'Shadow Dye',
      ...
      'Valor',
      'King Slime Boss Bag',
      'Eye Of Cthulhu Boss Bag',
      'Eater Of Worlds Boss Bag',
      'Brain Of Cthulhu Boss Bag',
      'Queen Bee Boss Bag',
      'Skeletron Boss Bag',
      'Wall Of Flesh Boss Bag',
      'Destroyer Boss Bag',
      'Twins Boss Bag',
      'Skeletron Prime Boss Bag',
      'Plantera Boss Bag',
      'Golem Boss Bag',
      'Fishron Boss Bag',
      'Cultist Boss Bag',
      ...
      'Hardened Sand Wall',
      'Corrupt Hardened Sand Wall',
      'Crimson Hardened Sand Wall',
      'Hallow Hardened Sand Wall',
      'Corrupt Sandstone Wall',
      'Crimson Sandstone Wall',
      'Hallow Sandstone Wall',
      'Desert Fossil',
      'Desert Fossil Wall',
      'Exotic Scimitar',
      'Paintball Gun',
      ...
      'Medusa Banner',
      'Greek Skeleton Banner',
      'Granite Flyer Banner',
      'Granite Golem Banner',
      'Blood Zombie Banner',
      'Drippler Banner',
      'Tomb Crawler Banner',
      'Dune Splicer Banner',
      'Flying Antlion Banner',
      'Walking Antlion Banner',
      'Desert Ghoul Banner',
      'Desert Lamia Banner',
      'Desert Djinn Banner',
      'Desert Basilisk Banner',
      'Ravager Scorpion Banner',
      'Stardust Soldier Banner',
      'Stardust Worm Banner',
      'Stardust Jellyfish Banner',
      'Stardust Spider Banner',
      'Stardust Small Cell Banner',
      'Stardust Large Cell Banner',
      'Solar Corite Banner',
      'Solar Sroller Banner',
      'Solar Crawltipede Banner',
      'Solar Drakomire Rider Banner',
      'Solar Drakomire Banner',
      'Solar Solenian Banner',
      'Nebula Soldier Banner',
      'Nebula Headcrab Banner',
      'Nebula Brain Banner',
      'Nebula Beast Banner',
      'Vortex Larva Banner',
      'Vortex Hornet Queen Banner',
      'Vortex Hornet Banner',
      'Vortex Soldier Banner',
      'Vortex Rifleman Banner',
